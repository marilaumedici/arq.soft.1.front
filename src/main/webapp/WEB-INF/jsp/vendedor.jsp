    	...
    	<div class="col-md-12">
    		<form:form method="post" action="addVendedorForm">
				<div class="form-group row">
				    ...
				    <div class="col-sm-5">
				      <form:input path="razonSocial" class="form-control" required="required" minlength="5" maxlength="30" />
				    </div>
			  	</div>
			  	<br>
			  	<div class="form-group row">
				    ...
				    <div class="col-sm-5">
				      <form:input path="email" pattern=".+@gmail\.com" title="Da una direcci&oacute;n de email de correcta" class="form-control" required="required" minlength="3" maxlength="60" />
				    </div>
			  	</div>
